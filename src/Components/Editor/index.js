...
import retangle1 from '../../Assets/retangle1.png';
...
class Editor extends Component {
  ...
  componentDidMount() {
    let box = document.getElementById('box-canvas');
    ...
    return (
      <div className={classes.root}>
        <div className={classes.header}>
          ...
          >
            <BottomNavigationAction sx={{ color: this.value === 0 ? 'red !important' : '#000000 !important', fontSize: '0.125rem !important' }} label="8100x8100" icon={<img src={square} style={{ width: '17px', height: 'auto' }} />} />
            <BottomNavigationAction sx={{ color: this.value === 1 ? 'red !important' : '#000000 !important', fontSize: '0.125rem !important' }} label="5700x8100" icon={<img src={retangle} style={{ width: '17px', height: 'auto' }} />} />
            <BottomNavigationAction sx={{ color: this.value === 2 ? 'red !important' : '#000000 !important', fontSize: '0.125rem !important' }} label="8100x5700" icon={<img src={retangle1} style={{ width: '18px', height: 'auto' }} />} />
          </BottomNavigation>
        </div>
        <div
          id="box-canvas"
        ...
        <div className={classes.footer}>
          <BottomNavigation sx={{ width: '100%', backgroundColor: '#000000', color: '#FFFFFF', height: '100%' }} value={this.value} onChange={this.handleChangeSize}>
            <BottomNavigationAction
              className={classes.bottomButton}
              label="Font"
              value="font"
              onClick={this.addText}
              icon={<AbcIcon className={classes.bottomIcon} />}
            />
            <BottomNavigationAction
              label="Photo"
              className={classes.bottomButton}
              ...
              icon={<>
                ...
                <label htmlFor="icon-button-file">
                  <ImageIcon className={classes.bottomIcon} />
                </label>
              </>}
            >
            </BottomNavigationAction>
            <Button
              ...
              variant="outlined"
              sx={{ borderRadius: '50%', borderColor: '#FFFFFF' }}
            >
              <ShoppingCartIcon fontSize="inherit" sx={{ width: '3rem', height: '3rem', color: '#FFFFFF' }} />
            </Button>
            <BottomNavigationAction
              label="Shape"
              className={classes.bottomButton}
              value="shape"
              icon={<InterestsIcon className={classes.bottomIcon} />}
            />
            <BottomNavigationAction
              label="Effect"
              className={classes.bottomButton}
              value="effect"
              icon={<LensBlurIcon className={classes.bottomIcon} />}
            />
          </BottomNavigation>
        </div>
      </div>
